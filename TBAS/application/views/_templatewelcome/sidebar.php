...
<div class="widget-sidebar">
	...
	<div class="sidebar-content">
		<ul class="list-sidebar">
			<?php
			$artikel = $this->db->query("SELECT * FROM artikel,user,kategori WHERE artikel_status='publish'	AND artikel_author=user_id AND artikel_kategori=kategori_id ORDER BY artikel_id DESC LIMIT 3")->result();
